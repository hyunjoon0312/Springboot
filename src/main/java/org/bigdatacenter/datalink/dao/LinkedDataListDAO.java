...
@Repository
public class LinkedDataListDAO {

	@Autowired
	@Qualifier("dataSource")
	private DataSource datasource;
	
	public ArrayList<LinkedDataListDTO> linkedDataList(String IRB){
		
		ArrayList<LinkedDataListDTO> linkedDataListDTOs = new ArrayList<>();
		...
		try {
			...
			while(rs.next()){
				...
				LinkedDataListDTO linkedDataListDTO = new LinkedDataListDTO(No, REPORT_YMD, ADDRESS, GENDER, DEATH_YMD, DEATH_TIME, DEATH_PLACE, DEATH_JOB, MARRY, EDU, DEATH_CAU1, DEATH_CAU1_Parent, DEATH_AGE, STND_Y, YKIHO_ID, YKIHO_GUBUN_CD, ORG_TYPE, YKIHO_SIDO, SICKBED_CNT, DR_CNT, CT_YN, MRI_YN, PET_YN);
