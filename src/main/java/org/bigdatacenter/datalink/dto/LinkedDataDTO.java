...
public class LinkedDataDTO {
	...
	public LinkedDataDTO(int No, String REPORT_YMD, int ADDRESS, int GENDER, String DEATH_YMD, int DEATH_TIME, int DEATH_PLACE, String DEATH_JOB,
	...
	public String toString() {
		return "LinkedDataDTO [NO=" + NO + ", REPORT_YMD=" + REPORT_YMD + ", ADDRESS=" + ADDRESS + ", GENDER=" + GENDER
				...
				+ ", YKIHO_ID=" + YKIHO_ID + ", YKIHO_GUBUN_CD=" + YKIHO_GUBUN_CD + ", ORG_TYPE=" + ORG_TYPE
				+ ", YKIHO_SIDO=" + YKIHO_SIDO + ", SICKBED_CNT=" + SICKBED_CNT + ", DR_CNT=" + DR_CNT + ", CT_YN="
				+ CT_YN + ", MRI_YN=" + MRI_YN + ", PET_YN=" + PET_YN + "]";
	}
